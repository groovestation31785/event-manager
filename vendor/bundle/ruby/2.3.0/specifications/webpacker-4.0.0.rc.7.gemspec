# -*- encoding: utf-8 -*-
# stub: webpacker 4.0.0.rc.7 ruby lib

Gem::Specification.new do |s|
  s.name = "webpacker".freeze
  s.version = "4.0.0.rc.7"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v4.0.0.rc.7/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v4.0.0.rc.7" } if s.respond_to? :metadata=
